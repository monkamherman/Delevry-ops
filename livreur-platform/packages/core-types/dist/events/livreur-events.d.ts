...
export declare enum LivreurEventType {
...
export declare enum LivreurAlertType {
    EMERGENCY = "emergency",
    ACCIDENT = "accident",
...
export type LivreurEvent = LivreurStatusChangedEvent | LivreurLocationUpdateEvent | LivreurAssignedEvent | LivreurAvailableEvent | LivreurOfflineEvent | LivreurShiftStartedEvent | LivreurShiftEndedEvent | LivreurAlertEvent;
